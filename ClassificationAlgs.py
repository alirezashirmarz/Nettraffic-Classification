...
""" Set Evaluation Set """
eval_set=DS[0:round(per_eval*Samples_count)][:]
print(eval_set.shape)
""" Set Test Dastaset """
test_set=DS[0:round(per_test*Samples_count)][:]
...
train_set_y[train_set_y=='Non-VPN']=bin(0) ## Set Y if is Non-VPN = 0 
train_set_y[train_set_y=='VPN']=bin(1)     ## Set  if is VPN = 1
...
eval_set_y[eval_set_y=='Non-VPN']=bin(0) ## Set Y if is Non-VPN = 0 
eval_set_y[eval_set_y=='VPN']=bin(1)     ## Set  if is VPN = 1
...
test_set_y[test_set_y=='Non-VPN']=bin(0) ## Set Y if is Non-VPN = 0 
test_set_y[test_set_y=='VPN']=bin(1)     ## Set  if is VPN = 1
...
""" Set binary to ys """
train_set_y[train_set_y==0]=bin(0)
train_set_y[train_set_y==1]=bin(1)

eval_set_y[eval_set_y==0]=bin(0)
eval_set_y[eval_set_y==1]=bin(1)

test_set_y[test_set_y==0]=bin(0)
test_set_y[test_set_y==1]=bin(1)
