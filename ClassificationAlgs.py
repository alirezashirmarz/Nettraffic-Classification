...
per_train=0.8           # 60% of samples is trained set
per_eval=0            # 20% of samples is evaluated set
...
scores1 = cross_val_score(clf, train_set_x, train_set_y, cv=10)
print ("Evaluation is",scores1)
print("Average Evaluation is:",np.average(scores1))
...
## Cross Validation 10 - fold
from sklearn.model_selection import cross_val_score
scores2 = cross_val_score(clf2, train_set_x, train_set_y, cv=10)
print ("Evaluation is",scores2)
print("Average Evaluation is:",np.average(scores2))
...
## Cross Validation 10 - fold
from sklearn.model_selection import cross_val_score
scores3 = cross_val_score(clf3, train_set_x, train_set_y, cv=10)
print ("Evaluation is",scores3)
print("Average Evaluation is:",np.average(scores3))
...
clf4.fit(train_set_x, train_set_y)
## Cross Validation 10 - fold

from sklearn.model_selection import cross_val_score
scores4 = cross_val_score(clf4, train_set_x, train_set_y, cv=10)
print ("Evaluation is",scores4)
print("Average Evaluation is:",np.average(scores4))
...
scores = cross_val_score(clf2, train_set_x, train_set_y, cv=5)
print (scores)
...
from sklearn.ensemble import RandomForestClassifier
clf2 = RandomForestClassifier(random_state=0)
scores = cross_val_score(clf2, train_set_x, train_set_y, cv=10)
print ("Evaluation is",scores)
print("Average Evaluation is:",np.average(scores))
"""